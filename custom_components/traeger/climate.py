...
from .const import GRILL_MIN_TEMP_C, GRILL_MIN_TEMP_F, PROBE_PRESET_MODES
...
async def async_setup_entry(
    ...
    for grill in grills:
        ...
        TraegerGrillMonitor(client, grill_id, async_add_entities, AccessoryTraegerClimateEntity)
    return True
...
class TraegerClimateEntity(TraegerBaseClimate):
    ...
    def hvac_mode(self) -> HVACMode:
        ...
        return GRILL_MODE_TO_HVAC_MODE.get(self.grill_state.system_status, HVACMode.OFF)
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        if self.grill_state is None:
            return
        if GrillMode.IGNITING <= self.grill_state.system_status <= GrillMode.CUSTOM_COOK:
